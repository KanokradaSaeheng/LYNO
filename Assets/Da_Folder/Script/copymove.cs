...
public class copymove : MonoBehaviour
{
    ...
    [Header("Walk Effect")]
    public AudioSource walkSound;              // Add in Inspector
    public ParticleSystem walkEffect;          // Add in Inspector
    ...
    {
        // your original GetTouchDirection code unchanged
